...
//		System.out.println(this.stringQueue.debugString()); 
	...
	public void testCaseResizeWhenWrappedAround() {
		...
		assertEquals(2, (int)this.intQueue.dequeue());
		assertEquals(3, (int)this.intQueue.dequeue());
		assertEquals("[4, 5, 6]", this.intQueue.toString());
		this.intQueue.enqueue(7);
		assertEquals("[4, 5, 6, 7]", this.intQueue.toString());
		this.intQueue.enqueue(8);
		assertEquals("[4, 5, 6, 7, 8]", this.intQueue.toString());
		this.intQueue.enqueue(9);
		assertEquals("[4, 5, 6, 7, 8, 9]", this.intQueue.toString());
		...
		assertEquals("a", this.stringQueue.dequeue());
		assertEquals("b", this.stringQueue.dequeue());
//		System.out.println(stringQueue.debugString());
		this.stringQueue.enqueue("f");
//		System.out.println(stringQueue.debugString());
		this.stringQueue.enqueue("g");
		// Full
