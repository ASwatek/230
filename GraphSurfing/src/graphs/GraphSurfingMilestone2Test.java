...
//	@Test
//	public void myALTest(){
//		String[] toInsert = {"a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p"};
//		HashSet<String> items = new HashSet<String>();
//		for (String str : toInsert) {
//			items.add(str);
//		}
//		Graph<String> g = new AdjacencyListGraph<String>(items);
//		g.addEdge("a", "b");
//		g.addEdge("a", "c");
//		g.addEdge("c", "d");
//		g.addEdge("c", "e");
...
//		g.addEdge("k", "o");
//		g.addEdge("k", "p");
//		System.out.println(g.shortestPath("a", "j"));
//	}
	...
	public void testWikiSurfingShortestPath() {
		...
		List<String> ky = livingPeopleALGraph.shortestPath("Elizabeth II", "Kylie Minogue");
...
//		Set<String> kyliePath = livingPeopleALGraph.stronglyConnectedComponent("Kylie Minogue");
//		for(String item : kyliePath){
